...
using eBaySearch.Services.WcfExtension;
...
namespace eBay.Services.Common
{
    ...
    public class ClientFactory
    {
        ...
        public static ClientBase<TServiceContract> GetServiceClient<TServiceContract>(ClientConfig config, Type clientType, string serviceName)
